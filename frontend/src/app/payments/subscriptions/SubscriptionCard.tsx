...
import YoutubeIcon from "../../icons/Capital-One-Logo.png"

const SubscriptionCard: React.FC<ICustomSubCard> = (props: ICustomSubCard) => {
  return (
    <div className="relative flex w-full max-w-[23rem] flex-col rounded-xl bg-transparent bg-clip-border bg-gray-100 text-gray-700 shadow-lg p-2 mb-2">
